...
public class PixQRCodeBuilder {
     ...
     * </ul>
     *
     * @param receiverFullName The receiver full name.
     *
     * @throws InvalidValueFormatException If the receiver name is longer than
     * 25 characters or is an empty/null field.
     */
     ...
     *
     * @throws InvalidValueFormatException If the receiver city is longer than
     * 15 characters or is an empty/null field.
     */
     ...
     *
     * @param withValue The withValue boolean.
     */
     ...
     * <li>The transaction identifier can be up to 20 characters long (letters
     * and numbers).
     ...
     *
     * @throws InvalidValueFormatException If the transaction identifier has
     * blanks, is longer than 20 characters, or has disallowed characters.
     */
     ...
     *
     * @throws InvalidValueFormatException If the pixKey is empty or null field.
     */
    ...
    public PixQRCodeBuilder descricao(@NotNull String pDescricao) throws InvalidValueFormatException {
        if (pDescricao == null || pDescricao.trim().equals("")) {
            throw new InvalidValueFormatException("A chave Descrição não pode ser um campo vazio ou nulo");
        }

        this.pixQRCode.setDescricao(pDescricao);
